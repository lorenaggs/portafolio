const content = {
  es: {
    ...
    title: "Arquitecturas modulares y escalables",
    summary: "Diseño y lidero arquitecturas modulares basadas en microfrontends y Angular, aplicando principios de programación orientada a objetos con arquitectura hexagonal para garantizar sistemas escalables, mantenibles y preparados para la evolución. Alineo estrategia, arquitectura y UX para entregar plataformas modernas, accesibles y de alto rendimiento.",
    secondary:
      "Angular · React · Microfrontends · Module Federation · Serverless · UX Data-Driven · Arquitectura limpia · Arquitectura hexagonal",
  ...
  en: {
    intro: "Frontend Lead · Microfrontends",
    title: "Modular and scalable architectures",
    ...
    secondary:
      "Angular · React · Microfrontends · Module Federation · Serverless · UX Data-Driven · Clean Architecture · Hexagonal architecture",
      ...
      <section className="banner-hero" id="hero">
        ...
        <div className="banner-hero__content">
          ...
          <h2 className="banner__headline">
            <span className="banner__headline-name">Lorena Guartazaca</span>
